...
class Level1():
    ...
    def setupWalls(self, wall_color):
        ...
        wall_positions = [
            ...
            [360,60,186,6],[60,120,66,6],[60,120,6,126],[180,120,246,6],[300,120,6,126],
        ...
        for walls_position in walls_positions:
            wall = Wall(*walls_position,wall_color)
    ...
    def setupPlayer(self,hero_image_path,gost_images_path):
        self.hero_sprites = pygame.sprite.Group()
        self.ghost_sprites = pygame.sprite.Group()
        self.hero_sprites.add(Player(287,439,hero_image_path))
        for each in gost_images_path:
            ...
            if role_name == "Blinky":
                ...
                player.tracks = [
                    ...
                    [-0.5, 0, 15], [0, 0.5, 11], [0.5, 0, 3], [0, -0.5, 11], [0.5, 0, 1]
                ]
    ...
    def setupFood(self,food_color,bg_color):
        ...
        for row in range(19):
            for col in range(19):
                if (row == 7 or row == 8) and (col == 9 and col == 9 or col == 10):
                    continue
                else:
